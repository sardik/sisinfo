...
if (isset($_GET['edit'])) {
    $edit = $_GET['edit'];
    $data = $proses->getone('tbl_guru','id_guru',$edit,$con);
...
function hapusfoto(){
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?php echo $judul; ?> Data Guru
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-laptop"></i> Master Data</a></li>
        <li class="active"><?php echo $judul; ?> data guru</li>
      </ol>
    </section>
      ...
      <div class="row">
		...
		<div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Form <?php echo $judul; ?> Data Guru</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" id="guru" action="proses/guru.php" name="guru" method="post">
