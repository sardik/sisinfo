...
if (isset($_GET['edit'])) {
    $edit = $_GET['edit'];
    $data = $proses->getone('tbl_topickuis','id_topkuis',$edit,$con);
    foreach ($data as $key => $value) {
      $nama_topic = $value['judul'];
      $id_mapel = $value['id_matapelajaran_kuis'];
      $tanggal_dibuat = $value['tgl_buat'];
    }
    $submit = 'edit';
    $judul = 'Edit';
}
...
?>
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?php echo $judul; ?> Topic Kuis
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-laptop"></i> Modul Pembelajaran</a></li>
        <li class="active"><?php echo $judul; ?> topic kuis</li>
      </ol>
    </section>
      ...
      <div class="row">
		...
		<div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Form <?php echo $judul; ?> Topic Kuis</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" id="guru" action="proses/topic_kuis.php" name="guru" method="post">
